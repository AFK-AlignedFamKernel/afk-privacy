use super::honk_verifier_circuits::{
    run_BN254_EVAL_FN_CHALLENGE_SING_51P_RLC_circuit,
    run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_15_circuit,
    run_GRUMPKIN_HONK_SUMCHECK_SIZE_15_PUB_4_circuit,
};
...
mod UltraKeccakHonkVerifier {
    ...
    use super::{
        precomputed_lines, run_BN254_EVAL_FN_CHALLENGE_SING_51P_RLC_circuit,
        run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_15_circuit,
        run_GRUMPKIN_HONK_SUMCHECK_SIZE_15_PUB_4_circuit, vk,
    };
    ...
    impl IUltraKeccakHonkVerifier of super::IUltraKeccakHonkVerifier<ContractState> {
        fn verify_ultra_keccak_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_HONK_SUMCHECK_SIZE_15_PUB_4_circuit(
            ...
            let (lhs_fA0) = run_BN254_EVAL_FN_CHALLENGE_SING_51P_RLC_circuit(
                A: random_point,
                coeff: mb.coeff0,
                SumDlogDivBatched: full_proof.msm_hint_batched.RLCSumDlogDiv,
            );
            let (lhs_fA2) = run_BN254_EVAL_FN_CHALLENGE_SING_51P_RLC_circuit(
