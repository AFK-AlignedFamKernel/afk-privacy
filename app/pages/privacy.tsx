...
export default function PrivacyPolicyPage() {
    return (
        <>
            <Head>
                <title>Privacy Policy - AFK</title>
            </Head>
            ...
            <div className="article">
                ...
                <div className="mt-3">
                    <h3>Introduction</h3>
                    <p>
                        At AFK, we are committed to protecting your privacy and ensuring the security 
                    ...
                    <p>
                        Internal messages in AFK are not encrypted. They are only hidden from the public field.
                        AFK server has access to all internal messages.
                        <br />
                    ...
                    <p>
                        ...
                        please reach out to us on <a href="https://x.com/AFK_AlignedFamK">X</a>.
                    </p>
                </div>
            </div>
        </>
